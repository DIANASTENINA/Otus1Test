...
public class PersonalAreaPage extends AbsCommon {
    ...
    public void addContactsOne(InputFieldData inputFieldData, String data, int number) {
        this.driver.findElement(By.xpath(
                "//button[@type='button' and text()='Добавить']")).click();
        this.waitTools.waitForCondition(ExpectedConditions.elementToBeClickable(By.xpath(
                "//span[@class=\"placeholder\" and text()=\"Способ связи\"]")));
        this.driver.findElement(By.xpath(
                "//span[@class=\"placeholder\" and text()=\"Способ связи\"]")).click();
        WebElement commMethodContainer = driver.findElement(By.xpath(
                "//div[@class='lk-cv-block__select-options " +
        ...
        WebElement inputData = this.driver.findElement(By.id(String.format(
                "id_contact-%s-value", number)));
        ...
        this.driver.findElement(By.cssSelector(
                "button.lk-cv-block__action.lk-cv-block__action_md-no-spacing.js-formset-add.js-lk-cv-custom-select-add")).click();
    }
    ...
    public void clickSavePersonalArea() {
        ...
        WebElement saveText = this.driver.findElement(By.xpath(
                "//div[@class='container container-padding-top-half container-padding-bottom-half']/span/span"));
